...
int main(int argc, const char* argv[])
{
    ...
    Ptr<musa::BroxOpticalFlow> brox = musa::BroxOpticalFlow::create(0.197f, 50.0f, 0.8f, 10, 77, 10);
    Ptr<musa::DensePyrLKOpticalFlow> lk = musa::DensePyrLKOpticalFlow::create(Size(7, 7));
    Ptr<musa::FarnebackOpticalFlow> farn = musa::FarnebackOpticalFlow::create();
    Ptr<musa::OpticalFlowDual_TVL1> tvl1 = musa::OpticalFlowDual_TVL1::create();
    Ptr<musa::NvidiaOpticalFlow_1_0> nvof_1_0 = musa::NvidiaOpticalFlow_1_0::create(frame0.size(),
        NvidiaOpticalFlow_1_0::NVIDIA_OF_PERF_LEVEL::NV_OF_PERF_LEVEL_FAST, false, false, false, 0, inputStream, outputStream);
    Ptr<musa::NvidiaOpticalFlow_2_0> nvof_2_0 = musa::NvidiaOpticalFlow_2_0::create(frame0.size(),
    ...
    {
        //The timing displayed below includes the time taken to copy the input buffers to the OF MUSA input buffers
        //and to copy the output buffers from the OF MUSA output buffer to the output buffer.
