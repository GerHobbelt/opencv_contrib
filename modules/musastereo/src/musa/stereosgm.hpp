...
#ifndef OPENCV_MUSASTEREO_SGM_HPP
#define OPENCV_MUSASTEREO_SGM_HPP
...
{
CV_EXPORTS void censusTransform(const GpuMat& src, GpuMat& dest, cv::musa::Stream& stream);
}
...
#endif /* OPENCV_MUSASTEREO_SGM_HPP */
